...
mixin _$CartState {
 ...
 Status get deleteStatus; Status get cartStatus; String? get errorDelete; String? get errorCart; MyCartItemsModel? get myCartItems;
...
@override
int get hashCode => Object.hash(runtimeType,deleteStatus,cartStatus,errorDelete,errorCart,myCartItems);

@override
String toString() {
  return 'CartState(deleteStatus: $deleteStatus, cartStatus: $cartStatus, errorDelete: $errorDelete, errorCart: $errorCart, myCartItems: $myCartItems)';
}
...
@useResult
$Res call({
 Status deleteStatus, Status cartStatus, String? errorDelete, String? errorCart, MyCartItemsModel? myCartItems
});
...
/// Create a copy of CartState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? deleteStatus = null,Object? cartStatus = null,Object? errorDelete = freezed,Object? errorCart = freezed,Object? myCartItems = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Status deleteStatus,  Status cartStatus,  String? errorDelete,  String? errorCart,  MyCartItemsModel? myCartItems)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartState() when $default != null:
return $default(_that.deleteStatus,_that.cartStatus,_that.errorDelete,_that.errorCart,_that.myCartItems);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Status deleteStatus,  Status cartStatus,  String? errorDelete,  String? errorCart,  MyCartItemsModel? myCartItems)  $default,) {final _that = this;
switch (_that) {
case _CartState():
return $default(_that.deleteStatus,_that.cartStatus,_that.errorDelete,_that.errorCart,_that.myCartItems);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Status deleteStatus,  Status cartStatus,  String? errorDelete,  String? errorCart,  MyCartItemsModel? myCartItems)?  $default,) {final _that = this;
switch (_that) {
case _CartState() when $default != null:
return $default(_that.deleteStatus,_that.cartStatus,_that.errorDelete,_that.errorCart,_that.myCartItems);case _:
  return null;
...
class _CartState implements CartState {
  const _CartState({required this.deleteStatus, required this.cartStatus, required this.errorDelete, required this.errorCart, required this.myCartItems});
...
/// Create a copy of CartState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? deleteStatus = null,Object? cartStatus = null,Object? errorDelete = freezed,Object? errorCart = freezed,Object? myCartItems = freezed,}) {
