...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('status', status))..add(DiagnosticsProperty('errorMessage', errorMessage))..add(DiagnosticsProperty('address', address));
}
...
class _AddressState with DiagnosticableTreeMixin implements AddressState {
  const _AddressState({required this.status, required this.errorMessage, required final  List<AddressModel> address}): _address = address;
